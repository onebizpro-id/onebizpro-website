...
export const PACKAGES: PackageInfo[] = [
  ...
  },
  {
    ...
    solutions: [
      ...
      { benefit: "Kirim penawaran, pelanggan approve sendiri", system: "Penawaran" },
      { benefit: "Pelanggan lihat & bayar tagihan sendiri", system: "Portal Pelanggan" },
    ],
    highlight: true,
  },
  {
    ...
    solutions: [
      ...
      { benefit: "Kelola proyek dari RAB sampai selesai", system: "Manajemen Proyek" },
    ],
    highlight: false,
  },
];
